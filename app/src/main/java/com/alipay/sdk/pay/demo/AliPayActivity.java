...
public class AliPayActivity extends FragmentActivity {
    ...
    // 商户PID
    public static final String PARTNER = "2088021131382319";
    // 商户收款账号
    public static final String SELLER = "472157129@qq.com";
    // 商户私钥，pkcs8格式
    ...
    private Handler mHandler = new Handler() {
        public void handleMessage(Message msg) {
            ...
            case SDK_PAY_FLAG: {
                ...
                Log.d(TAG, "AliPay result=" + resultInfo + ", resultStatus="+resultStatus);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mSubjectView = (TextView) findViewById(R.id.product_subject);
        mBodyView = (TextView) findViewById(R.id.product_body);
        mPriceView = (TextView) findViewById(R.id.product_price);
    ...
    public String getOrderInfo(String subject, String body, String price) {
        ...
        orderInfo += "&notify_url=" + "\"" + "http://116.255.239.201:8080/buyService/paynotify" + "\"";
