...
public class UmengShareUtils {
	...
	final String QQAppId = "1104758747";
...
//	private final String WXAppSecret = "c6e74a086068107f713404b01e460597";
	...
	public UmengShareUtils(final Activity mActivity,String content,final String url,String title,UMImage urlImage) {
...
//	 微信回调
    SnsPostListener mSnsPostListener = new SnsPostListener() {
        ...
        public void onComplete(SHARE_MEDIA platform, int stCode,
            ...
            if (stCode == 200) {
                Toast.makeText(mActivity, "分享成功"+ stCode, Toast.LENGTH_SHORT)
                        .show();
            } else {
