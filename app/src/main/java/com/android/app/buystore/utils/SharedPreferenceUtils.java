...
//    private static final String userIconDefault = "http://a.hiphotos.baidu.com/image/pic/item/cdbf6c81800a19d8fc5fdb0f31fa828ba61e465f.jpg";
    ...
    public static void saveHeadicon(Context context, String icon) {
        sp.edit().putString("headicon", icon).commit();
    }
    ...
    public static void saveNickName(Context context, String nikeName) {
        sp.edit().putString("nikeName", nikeName).commit();
    }
    ...
    public static void saveUserPosition(Context context, String userPosition) {
        sp.edit().putString("userPosition", userPosition).commit();
    }
    ...
    public static void saveAppWhenFirstLaunch(Context context, boolean isFirstLaunch) {
        sp.edit().putBoolean("launch", isFirstLaunch).apply();
    }
