...
public class CommentListAdapter extends BaseAdapter {
    ...
    private List<GsonCommentBean.CommodityEvalListBean> datas;

    public CommentListAdapter(Context context, List<GsonCommentBean.CommodityEvalListBean> list) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        GsonCommentBean.CommodityEvalListBean commodityEvalListBean = datas.get(position);
        ...
        List<GsonCommentBean.CommodityEvalListBean.ListimgBean> listimgBeans = new ArrayList<GsonCommentBean.CommodityEvalListBean.ListimgBean>();
        ...
        if (listimgBeans.size() > 0) {
            ...
            LinearLayout.LayoutParams lp2 = new LinearLayout.LayoutParams(80, 80);
