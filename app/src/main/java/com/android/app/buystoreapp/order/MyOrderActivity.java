 ...
 */
public class MyOrderActivity extends BaseAct implements View.OnClickListener {

    private int[] ids = {R.id.tv_total, R.id.tv_wait_pay, R.id.tv_wait_send, R.id
            .tv_wait_harvest, R.id.tv_wait_rated};
    private String[] titleName;
    private Fragment[] fragments = {new TotalFragment(), new WaitPayFragment(),new WaitSendFragment(),new WaitHarvestFragment(),new WaitRatedFragment()};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        userStatus = getIntent().getIntExtra("userStatus",0);//身份（1卖家 or 0买家）
        if (userStatus == 0){
    ...
    private void initView() {
        titleName = getResources().getStringArray(R.array.order_details);
