...
public class PersonalSettingsActivity extends BaseAct implements View.OnClickListener {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case SubscribeActivity.HANDLE_LOADMORE:
                    if (list.size() == 0) {
                        Intent addAddress = new Intent(PersonalSettingsActivity.this, AddAddressActivity.class);
                        addAddress.putExtra("size", 0);
                        startActivity(addAddress);
                        ToastUtil.showMessageDefault(PersonalSettingsActivity.this, "您还没有添加地址，请先添加地址");
                    } else {
                        Intent addressList = new Intent(PersonalSettingsActivity.this, MyAddressListActivity.class);
    ...
    private void initView() {
        ((TextView) findViewById(R.id.tv_title)).setText(getResources().getString(R.string.personal_set));
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.rl_personal_data://个人资料
                Intent intentData = new Intent(PersonalSettingsActivity.this, PersonalDataActivity.class);
                startActivity(intentData);
                break;
            case R.id.rl_account_security://账号安全
                Intent intentsafe = new Intent(PersonalSettingsActivity.this, AccountSafeActivity.class);
            ...
            case R.id.ib_personal_setting_exit://退出当前账户
                ...
                CustomDialog.btnLeft.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        ...
                        exit();
                        startActivity(new Intent(PersonalSettingsActivity.this, BossBuyActivity.class));
    ...
    public void getReceive() {
        ...
        HttpUtils.post(mContext, obj, new AsyncHttpResponseHandler() {
            ...
            public void onFailure(int i, Header[] headers, byte[] bytes, Throwable throwable) {
                stopLoadingAnim();
                ToastUtil.showMessageDefault(PersonalSettingsActivity.this, getResources().getString(R.string.service_error_hint));
            }
