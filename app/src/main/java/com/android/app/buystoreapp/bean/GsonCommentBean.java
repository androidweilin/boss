...
public class GsonCommentBean implements Serializable{
    ...
    private List<CommodityEvalListBean> commodityEvalList;
    ...
    public List<CommodityEvalListBean> getCommodityEvalList() {
        return commodityEvalList;
    }

    public void setCommodityEvalList(List<CommodityEvalListBean> commodityEvalList) {
     ...
     * 评价信息
     */
    public static class CommodityEvalListBean implements Serializable{
