        ...
        public void handleMessage(Message msg) {
            switch (msg.what) {
                ...
                case SELOPENVIP_SUCCESS:
                    ...
                    TextView[] tv = new TextView[]{tv01_usefulTime, tv02_usefulTime, tv03_usefulTime};
                    TextView[] oldPrice = new TextView[]{tv01_original, tv02_original, tv03_original};
                    TextView[] newPrice = new TextView[]{tv01_currentPrice, tv02_currentPrice, tv03_currentPrice};
    ...
    private void selOpenVip() {
        ...
        HttpUtils.post(mContext, obj, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                Gson gson = new Gson();
                SelOpenVipBean selOpenVipBean = gson.fromJson(new String(bytes), new TypeToken<SelOpenVipBean>() {
                }.getType());
            ...
            public void onFailure(int i, Header[] headers, byte[] bytes, Throwable throwable) {
                stopLoadingAnim();
                ToastUtil.showMessageDefault(VipActivity.this, getResources().getString(R.string.service_error_hint));
            }
    ...
    private void openVip() {
        ...
        HttpUtils.post(mContext, obj, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                Gson gson = new Gson();
                OpenVipBean openVipBean = gson.fromJson(new String(bytes), new TypeToken<OpenVipBean>() {
                }.getType());
