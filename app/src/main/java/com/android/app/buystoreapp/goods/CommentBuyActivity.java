...
public class CommentBuyActivity extends Activity implements View.OnClickListener,
    ...
    private List<GsonCommentBean.CommodityEvalListBean> list = new ArrayList<GsonCommentBean.CommodityEvalListBean>();
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                ...
                case LOAD_CANCLE:
                    ...
                    break;
                case REFRESH_END:
                    totalEvalNum = goodEvalNum + mediumEvalNum + badEvalNum + imgIsNotNullNum;
