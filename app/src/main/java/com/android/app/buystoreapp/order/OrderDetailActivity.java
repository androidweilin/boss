        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case 111:
                    ...
                    tv_harvest_address.setText(address.getReceiverArea() + address.getReceiverAdd() + address.getReceiverStreet());
                ...
                if (userStatus == 0) {
                    ...
                    switch (v.getId()) {
                        ...
                        case R.id.btn2_order:
                            ...
                            intent.putExtra(Constant.EXTRA_USER_NAME, orderDetail.getSellNickname());
                    ...
                    switch (v.getId()) {
                        case R.id.btn1_order:
                            ...
                            CustomDialog.btnLeft.setOnClickListener(new View.OnClickListener() {
                                ...
                                public void onClick(View v) {
                                    CustomDialog.dialog.dismiss();
                                    Intent intent = new Intent(OrderDetailActivity.this, ApplyRefundAct.class);
                                    String orderId = orderDetail.getOrderId();
                ...
                if (userStatus == 0) {
                    switch (v.getId()) {
                        case R.id.btn1_order:
                            ...
                            Intent webIntent = new Intent(OrderDetailActivity.this, BaseWebActivity.class);
                ...
                if (userStatus == 0) {
                    switch (v.getId()) {
                        ...
                        case R.id.btn2_order:
                            ...
                            ratedIntent.putExtra("orderProduct", (OrderProduct) orderProduct);
    ...
    private void getLogistics() {
        ...
        HttpUtils.post(mContext, obj, new AsyncHttpResponseHandler() {
            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                stopLoadingAnim();
                Gson gson = new Gson();
                GsonWayBillBack gsonWayBillBack = gson.fromJson(new String(bytes), new TypeToken<GsonWayBillBack>() {
                }.getType());
