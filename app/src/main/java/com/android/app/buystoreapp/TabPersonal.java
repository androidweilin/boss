                ...
                if (isLogin) {
                    switch (index) {
                        ...
                        case 2:
                            ...
                            break;
                        case 3:
                            Intent ratedIntent = new Intent(getActivity(), SesameCreditActivity.class);
            ...
            private void versionUpdate() {
                ...
                HttpUtils.post(getContext(), obj, new AsyncHttpResponseHandler() {
                    ...
                    public void onSuccess(int i, Header[] headers, byte[] bytes) {
                        ...
                        stopLoadingAnim();
                        Gson gson = new Gson();
                        VersionUpdateBack versionUpdateBack = gson.fromJson(new String(bytes), new TypeToken<VersionUpdateBack>() {
                        }.getType());
                        if ("0".equals(versionUpdateBack.getResult())) {
                            if (versionUpdateBack.getAppVersion().getVersionCode() > Config.getVersionCode(getContext())) {
//                  Intent intent = new Intent(getContext(), VersionManagerService.class);
