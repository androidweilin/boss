...
public class ConfirmOrderActivity extends BaseAct implements OnClickListener {
    ...
    private List<OrderPro> scobList = new ArrayList<OrderPro>();
    ...
    private List<GsonOrderAddressBack.OrderAddress> mAddressDatas = new ArrayList<GsonOrderAddressBack.OrderAddress>();
            ...
            public void onClick(View arg0) {
               /* Intent addressIntent = new Intent(ConfirmOrderActivity.this,
                ...
                if (isNoAddress) {
                    ...
                    startActivity(new Intent(ConfirmOrderActivity.this, MyAddressListActivity.class));
                }
            }
        });
        ...
        switch (v.getId()) {
            case R.id.id_confirm_order_submit:
                ...
                for (int i = 0; i < mListGoods.size(); i++) {
                    ...
                    TextView mo = (TextView) mListView.getChildAt(i).findViewById(R.id.tv_fireght_modes);
                    EditText leave = (EditText) mListView.getChildAt(i).findViewById(R.id.et_order_leave_message);
                    modes = mo.getText().toString().trim();
...
//                        findDefaultAddress();
   ...
   /* private void findDefaultAddress() {
    ...
    private void initHeadAddressViews() {
        ...
        mHeadAddress.setText(mAddressDatas.get(0).getReceiverArea() + mAddressDatas.get(0).getReceiverStreet() + mAddressDatas.get(0).getReceiverAdd());
    }

    private void requestSendCommodites() {
        ConfrimOrderPostBean data = new ConfrimOrderPostBean("createOrder", userid, mTotalPrice, postbean);
        JSONObject obj = null;
        try {
