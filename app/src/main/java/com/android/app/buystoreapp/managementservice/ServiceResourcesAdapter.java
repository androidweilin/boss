...
//        return 3;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        holder.id_service_resources_distance.setText(dataList.get(position).getProDistance());
...
//        });
    ...
    class ViewHolder {
        ...
        TextView id_service_resources_salenum;//已售[69]单
        TextView tv_service_resources_surplus;//仅剩[998]单
