            ...
            public void onSuccess(int i, Header[] headers, byte[] bytes) {
                ...
                if (result.equals("0")) {
                    ...
                    if (gpbpsLists.size() == 0) {
                        ...
                        adapter = new ManagementAdapter(mContext, gpbpsLists, refreshCount, userLevelMark);
    ...
    public void doClic(View view, final int i) {
        switch (view.getId()) {
            ...
            case R.id.btn_mangement_share://分享
                ...
                umengShareUtils = new UmengShareUtils(getActivity(), gpbpsLists.get(i).getProName(), _url + gpbpsLists.get(i).getProId(), userNikeName, urlImage);
