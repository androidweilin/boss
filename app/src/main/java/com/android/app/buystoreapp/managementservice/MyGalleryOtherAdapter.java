...
//            holder.id_index_gallery_item_image = (ImageView) view.findViewById(R.id.id_index_gallery_item_image);
//            holder.id_index_gallery_item_text = (TextView) view.findViewById(R.id.id_index_gallery_item_text);
//            holder.id_gallery_item_money = (TextView) view.findViewById(R.id.id_gallery_item_money);
            view.setTag(holder);
        }else {
...
//            Picasso.with(context).load(list.get(i).getProImageUrl()).placeholder(R.drawable.ic_boss_default).into(holder.id_index_gallery_item_image);
//        }
