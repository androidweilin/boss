 ...
 * 滑动选择
 */
public class MyScrollerNumberPicker extends View {
	/** 控件宽度 */
	...
	public MyScrollerNumberPicker(Context context, AttributeSet attrs, int defStyle) {
		super(context, attrs, defStyle);
		init(context, attrs);
		initData();
	}

	public MyScrollerNumberPicker(Context context, AttributeSet attrs) {
		super(context, attrs);
		init(context, attrs);
		initData();
	}

	public MyScrollerNumberPicker(Context context) {
		super(context);
		initData();
	}
