 ...
 */
public class ProductListActivity extends BaseAct implements OnRefreshListener, OnLoadListener, View.OnClickListener ,HomeProListAdapter.OnClickToMoreInterface{
...
//    private String categoryName;
    ...
    private AdapterView.OnItemClickListener mBusinessListener = new AdapterView.OnItemClickListener() {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (where == 1){
            ...
            if (!TextUtils.isEmpty(categoryBkground)) {
                Picasso.with(this).load(categoryBkground).placeholder(R.drawable.ic_product_list_title_bg).into(background);
            }
        }
       ...
       /* userLat = cityInfoBean.getCityLat();
        ...
        userLong = (TextUtils.isEmpty(cityInfoBean.getCityLong()) ? "0" : cityInfoBean.getCityLong());
...
//                        mShopCategory);
        ...
        viewFilter.setOnSelectListener(new ViewFilter.OnSelectListener() {
            @Override
            public void getValue(int body, int transaction, String from, String to, String severlable) {
