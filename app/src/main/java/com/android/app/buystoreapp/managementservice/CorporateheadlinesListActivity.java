...
public class CorporateheadlinesListActivity extends BaseAct implements SwipeRefreshLayoutUpDown.OnRefreshListener, SwipeRefreshLayoutUpDown.OnLoadListener {
    ...
    private void initView() {
        ((TextView)findViewById(R.id.tv_title)).setText(getResources().getString(R.string.corporate_head_lines));
...
//                    BaseWebActivity.class);
                ...
                Intent loginIntent = new Intent(CorporateheadlinesListActivity.this, LoginActivity.class);
    ...
    private void requestNewsFromHttp() {
        ...
        LogUtils.d("requestNewsFromHttp:" + param);
...
//                        mSwipeLayout.setRefreshing(false);
                        stopLoadingAnim();
                        ToastUtil.showMessageDefault(CorporateheadlinesListActivity.this,getResources().getString(R.string.service_error_hint));
                    }
                });
    }
