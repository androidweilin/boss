 ...
 * weilin
 */
public class LpebListAdapter extends BaseAdapter {
    private LayoutInflater inflater;
    private List<LpebListBean> dataList;
    ...
    public LpebListAdapter(Context context, List<LpebListBean> data) {
        this.dataList = data;
...
//        return 3;
    ...
    public View getView(final int position, View convertView, ViewGroup parent) {
        ...
        if (dataList.get(position).getAttentionIsOff() == 1) {
        ...
        } else if (dataList.get(position).getAttentionIsOff() == 0) {
            holder.tv_attention_button.setText("未关注");
            holder.tv_attention_button.setTextColor(context.getResources().getColor(R.color.c_7f7f7f));
            holder.tv_attention_button.setTextSize(18);
            holder.tv_attention_button.setBackgroundResource(R.drawable.corners_f1f1f1_bg);
        }
